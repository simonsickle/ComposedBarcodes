 ...
 * Note: Due to async barcode generation, these tests capture the loading state.
 * For full barcode rendering tests, use instrumented tests or manual verification.
 */
